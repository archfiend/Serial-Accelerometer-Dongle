...
SRC = $(TARGET).c
SRC += $(EXTRAINCDIRS)/adc.c
SRC += $(EXTRAINCDIRS)/uart.c
SRC += $(EXTRAINCDIRS)/timer2.c
SRC += $(EXTRAINCDIRS)/eeprom.c
...
STK500_PATH = "C:\Program Files (x86)\Atmel\AVR Tools\STK500"
